...
class AgentTrace(Base):
    ...
    routed_to: Mapped[str] = mapped_column(String(32))        # knowledge | account | escalation | smalltalk
...
class Ticket(Base):
    """E2 — Escalation tickets created by the EscalationAgent."""
...
class IdempotencyRecord(Base):
    """E1 — Stores responses keyed by Idempotency-Key for replay."""
